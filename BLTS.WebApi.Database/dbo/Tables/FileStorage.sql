CREATE TABLE [dbo].[FileStorage] (
    ...
    [IsAuthorizationRequired] BIT            CONSTRAINT [DF_FileStorage_IsAuthorizationRequired] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_FileStorage] PRIMARY KEY CLUSTERED ([FileStorageId] ASC) WITH (FILLFACTOR = 90, ALLOW_PAGE_LOCKS = OFF, PAD_INDEX = ON)
);
